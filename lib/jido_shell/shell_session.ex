defmodule Jido.Shell.ShellSession do
  ...
  - `:backend` - Backend tuple `{module, config}` (default: local backend)

  ## Examples

      iex> {:ok, session_id} = Jido.Shell.ShellSession.start("my_workspace")
  ...
  ## Examples
      ...
      iex> id = Jido.Shell.ShellSession.generate_id()
  ...
  ## Examples
      ...
      iex> Jido.Shell.ShellSession.via_registry("sess-123")
      {:via, Registry, {Jido.Shell.SessionRegistry, "sess-123"}}
  """
  ...
  ## Examples
      ...
      iex> Jido.Shell.ShellSession.lookup("nonexistent")
      {:error, :not_found}
  """
  ...
  ## Examples
      ...
      iex> {:ok, session_id} = Jido.Shell.ShellSession.start_with_vfs("my_workspace")
      iex> String.starts_with?(session_id, "sess-")
      true
  """
